  ...
  if (selectedModel) {
    return (
      <div className="min-h-screen bg-transparent text-gray-900 dark:text-gray-100 flex flex-col">
        <header className="px-6 pt-12 pb-5 border-b border-gray-200 dark:border-[#273654]/80 sticky top-0 bg-gray-50/80 backdrop-blur-xl z-30">
          <div className="flex items-center justify-between max-w-5xl mx-auto w-full gap-4">
            <div className="flex items-center gap-4">
              <button
                onClick={() => setSelectedModelId(null)}
                className="p-2.5 rounded-xl bg-gray-50 dark:bg-[#1C283F] hover:bg-gray-100 dark:bg-[#1C283F] border border-gray-200 dark:border-[#273654]/60 shadow-sm text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:text-gray-100 transition-all active:scale-95"
              >
            ...
            <div className="flex items-center gap-2">
              <button
                onClick={clearForm}
                className="px-4 py-2 text-xs font-bold text-gray-600 dark:text-gray-400 hover:text-white bg-white dark:bg-[#162032] border border-gray-300 dark:border-[#3A4D71] rounded-lg transition-colors"
              >
                Limpar
              </button>
            </div>
          ...
          <div className="max-w-5xl mx-auto space-y-10 pb-12">
            ...
            {selectedModel.tables.map((table, tIdx) => (
              <div key={tIdx} className="space-y-4">
                <h3 className="text-sm font-bold text-gray-700 dark:text-gray-300 flex items-center justify-between uppercase tracking-widest border-b border-gray-200 dark:border-[#273654]/80 pb-2">
                ...
                <div className="grid grid-cols-1 gap-3">
                  {table.rows.map((row, rIdx) => {
                    ...
                    return (
                      <div key={rowKey} className="flex flex-col sm:flex-row gap-4 p-4 sm:p-5 bg-white dark:bg-[#162032] border border-gray-200 dark:border-[#273654]/60 shadow-sm rounded-2xl transition-all hover:bg-white dark:bg-[#162032] hover:border-red-600/30 hover:shadow-red-600/10 hover:shadow-lg">
                        {/* Info Section */}
                        <div className="flex-1 space-y-2">
                          <div className="flex items-start justify-between">
                            ...
                            <button 
                              ...
                              className="inline-block px-2 py-0.5 bg-gray-200 dark:bg-[#1C283F] hover:bg-gray-200 dark:bg-[#1C283F] border border-gray-400 rounded text-gray-600 dark:text-gray-400 font-mono font-bold text-[10px] transition-colors active:scale-95"
                            >
                              {row.tipo}
                            </button>
                          </div>
                        ...
                        <div className="w-full sm:w-64 flex flex-col justify-between gap-3 shrink-0">
                          <div>
                            ...
                            <input
                              ...
                              className="w-full bg-gray-50/80 border border-gray-300 dark:border-[#3A4D71] rounded-lg px-3 py-2 text-sm text-gray-900 dark:text-gray-100 focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500/50 transition-all placeholder:text-gray-500 font-mono"
                            />
                          </div>
                            ...
                            <button
                              ...
                              className={`flex-1 flex items-center justify-center gap-1.5 py-2 px-3 rounded-lg text-xs font-bold transition-all border ${
                                currentStatus === 'ok' 
                                  ...
                                  : 'bg-white dark:bg-[#162032] text-gray-500 border-gray-300 dark:border-[#3A4D71] hover:bg-gray-200 dark:bg-[#1C283F]'
                              }`}
                            >
        ...
        <AnimatePresence>
          {selectedAbbr && (
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-white dark:bg-[#162032] backdrop-blur-sm"
            ...
            >
              <motion.div
                ...
                className="bg-white dark:bg-[#162032] border border-gray-300 dark:border-[#3A4D71] rounded-2xl p-6 max-w-sm w-full shadow-2xl"
              >
                <div className="flex items-center justify-between mb-4">
                  ...
                  <button
                    onClick={() => setSelectedAbbr(null)}
                    className="p-2 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:text-gray-100 bg-gray-200 dark:bg-[#1C283F] hover:bg-gray-300 rounded-full transition-colors"
                  >
                    <X className="w-5 h-5" />
                  </button>
                </div>
          ...
          {selectedTutorial && (
            ...
            >
              <motion.div
                ...
                exit={{ scale: 0.95, opacity: 0 }}
                onClick={(e) => e.stopPropagation()}
                className="bg-white dark:bg-[#162032] border border-gray-300 dark:border-[#3A4D71] rounded-2xl p-6 max-w-md w-full shadow-2xl flex flex-col max-h-[85vh]"
              >
                <div className="flex items-center justify-between mb-6 shrink-0">
                  ...
                  <button
                    onClick={() => setSelectedTutorial(null)}
                    className="p-2 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:text-gray-100 bg-gray-200 dark:bg-[#1C283F] hover:bg-gray-300 rounded-full transition-colors self-start"
                  >
                    <X className="w-5 h-5" />
                  </button>
                </div>
                ...
                <div className="overflow-y-auto pr-2 space-y-4">
                  {selectedTutorial.steps.map((step, idx) => {
                    ...
                    if (isHeader) {
                      return (
                        <div key={idx} className="mt-4 mb-1 border-b border-gray-200 dark:border-[#273654] pb-1">
                    ...
                    return (
                      <div key={idx} className={`flex gap-3 ${isWaveform ? 'flex-col bg-white dark:bg-[#162032] p-3 rounded-lg border border-gray-200 dark:border-[#273654] mt-4' : ''}`}>
                        ...
                        {isWaveform && selectedTutorial.title.includes("BOBINA DE IGNIÇÃO") && (
                          <div className="mt-4 pt-4 border-t border-gray-200 dark:border-[#273654]/80">
      ...
      <main key="list" className="flex-1 p-4 md:p-6 overflow-y-auto">
        <div className="max-w-4xl mx-auto space-y-8 pb-12">
          ...
          <div className="space-y-4">
            ...
            {models.length === 0 ? (
               <div className="text-center py-16 bg-white dark:bg-[#162032] rounded-3xl border border-gray-200 dark:border-[#273654]/60 shadow-sm">
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                {models.map(model => (
                  <button
                    ...
                    className="group w-full flex items-center justify-between p-5 bg-white dark:bg-[#162032] border border-gray-200 dark:border-[#273654]/60 shadow-sm rounded-2xl text-left hover:bg-gray-200 dark:bg-[#1C283F]/60 hover:border-emerald-500/30 transition-all shadow-sm active:scale-[0.98]"
                  >
                    ...
                    <div className="w-8 h-8 rounded-full bg-gray-50 dark:bg-[#1C283F] flex items-center justify-center group-hover:bg-emerald-600/10 transition-colors">
