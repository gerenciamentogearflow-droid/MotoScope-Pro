...
export function AdminPanel({ adminUser, onBack, onUserUpdate }: AdminPanelProps) {
  ...
  return (
    <div className="min-h-screen bg-transparent text-gray-900 dark:text-gray-100 flex flex-col">
      <header className="px-4 pt-12 pb-4 bg-white dark:bg-[#1A2235] border-b border-gray-300 dark:border-[#3D5280] z-10 shadow-sm">
        <div className="flex items-center gap-3">
          <button
            onClick={onBack}
            className="p-2 -ml-2 rounded-full hover:bg-gray-200 dark:bg-[#232F46] text-gray-600 dark:text-gray-400 transition-colors"
          >
      ...
      <main className="flex-1 p-4 space-y-6">
        ...
        <motion.div
          ...
          className="bg-white dark:bg-[#1A2235] border border-gray-300 dark:border-[#3D5280] rounded-xl p-5 shadow-sm"
        >
          ...
          <form onSubmit={handleProfileUpdate} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full bg-white dark:bg-[#1A2235] border border-gray-300 dark:border-[#3D5280] rounded-lg px-3 py-2 text-gray-900 dark:text-gray-100 focus:outline-none focus:border-red-600 shadow-sm"
                required
              />
            </div>
            <div>
              ...
              <input
                ...
                className="w-full bg-white dark:bg-[#1A2235] border border-gray-300 dark:border-[#3D5280] rounded-lg px-3 py-2 text-gray-900 dark:text-gray-100 placeholder:text-gray-600 dark:text-gray-400 focus:outline-none focus:border-red-600 shadow-sm"
              />
            </div>
        ...
        {adminUser.role === "admin" && (
          <>
            <motion.div
              ...
              className="bg-white dark:bg-[#1A2235] border border-gray-300 dark:border-[#3D5280] rounded-xl p-5 shadow-sm mb-6"
            >
              ...
              <div className="flex items-center justify-between py-2">
                ...
                >
                  <div className={`w-4 h-4 rounded-full bg-white dark:bg-[#1A2235] shadow-sm transition-transform ${showCourse ? 'translate-x-6' : 'translate-x-0'}`} />
                </button>
              </div>
            </motion.div>
              ...
              <form onSubmit={handleRegister} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-white dark:bg-[#1A2235] border border-gray-300 dark:border-[#3D5280] rounded-lg px-3 py-2 text-gray-900 dark:text-gray-100 placeholder:text-gray-600 dark:text-gray-400 focus:outline-none focus:border-emerald-500 shadow-sm"
                    required
                  />
                </div>
                <div>
        ...
        {editingUser && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-white/50 backdrop-blur-sm">
            <motion.div
              ...
              className="w-full max-w-md bg-white dark:bg-[#1A2235] border border-gray-300 dark:border-[#3D5280] rounded-2xl p-6 shadow-2xl relative"
            >
              <button
                onClick={() => setEditingUser(null)}
                className="absolute top-4 right-4 p-1.5 rounded-full hover:bg-gray-200 dark:bg-[#232F46] text-gray-600 dark:text-gray-400 hover:text-gray-700 dark:text-gray-300 transition-colors"
              >
                <X className="w-5 h-5" />
              </button>
              ...
              <form onSubmit={handleEditUserSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-white dark:bg-[#1A2235] border border-gray-300 dark:border-[#3D5280] rounded-lg px-3 py-2 text-gray-900 dark:text-gray-100 focus:outline-none focus:border-red-600 shadow-sm text-sm"
                    required
                  />
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      placeholder="Deixe em branco para manter a atual"
                      className="w-full bg-white dark:bg-[#1A2235] border border-gray-300 dark:border-[#3D5280] rounded-lg pl-3 pr-10 py-2 text-gray-900 dark:text-gray-100 placeholder:text-gray-600 dark:text-gray-400 focus:outline-none focus:border-red-600 shadow-sm text-sm"
                    />
                    <button
                      type="button"
                ...
                <div className="flex justify-end gap-2 pt-2">
                  <button
                    type="button"
                    onClick={() => setEditingUser(null)}
                    className="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:bg-[#232F46] rounded-lg transition-colors border border-gray-300 dark:border-[#3D5280]"
                  >
                    Cancelar
                  </button>
                  <button
        ...
        {userToDelete && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-white/50 backdrop-blur-sm">
            <motion.div
              ...
              animate={{ opacity: 1, scale: 1 }}
              exit={{ opacity: 0, scale: 0.95 }}
              className="w-full max-w-sm bg-white dark:bg-[#1A2235] border border-gray-300 dark:border-[#3D5280] rounded-2xl p-6 shadow-2xl relative"
            >
              <div className="flex flex-col items-center text-center">
                ...
                <div className="flex w-full gap-2">
                  <button
                    ...
                    className="flex-1 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:bg-[#232F46] rounded-lg transition-colors border border-gray-300 dark:border-[#3D5280]"
                  >
                    Não, cancelar
                  </button>
                  <button
