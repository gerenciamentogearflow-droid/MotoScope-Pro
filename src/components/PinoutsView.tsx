          ...
          <div className="max-w-4xl mx-auto space-y-10 pb-12">
            ...
            {selectedModel.modules.map((mod, idx) => (
              <div key={idx} className="space-y-4">
                <h3 className="text-sm font-bold text-rose-600 uppercase tracking-widest border-b border-gray-200 dark:border-[#2A3B5C]/80 pb-2">
                  {mod.name}
                </h3>
                
                {mod.pinout.length > 0 ? (
                  <div className="overflow-x-auto rounded-[1.5rem] border border-gray-200 dark:border-[#2A3B5C]/60 shadow-sm bg-white dark:bg-gray-900 backdrop-blur-sm shadow-xl">
                  ...
                  <div className="text-center py-12 bg-white dark:bg-gray-900 rounded-3xl border border-gray-200 dark:border-[#2A3B5C]/60 shadow-sm">
      ...
      <main className="flex-1 p-4 md:p-6 overflow-y-auto">
        <div className="max-w-4xl mx-auto space-y-8 pb-12">
          ...
          <div className="space-y-4">
            ...
            {models.length === 0 ? (
               <div className="text-center py-16 bg-white dark:bg-gray-900 rounded-3xl border border-gray-200 dark:border-[#2A3B5C]/60 shadow-sm">
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                {models.map(model => (
                  <button
                    ...
                    className="group w-full flex items-center justify-between p-5 bg-white dark:bg-gray-900 border border-gray-200 dark:border-[#2A3B5C]/60 shadow-sm rounded-2xl text-left hover:bg-gray-200 dark:bg-[#232F46]/60 hover:border-red-600/30 hover:shadow-red-600/10 hover:shadow-lg transition-all shadow-sm active:scale-[0.98]"
                  >
