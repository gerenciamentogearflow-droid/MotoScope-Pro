  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-transparent">
      <motion.div
        ...
        className="w-full max-w-[360px] bg-white dark:bg-[#1A2235] border border-gray-200 dark:border-[#2A3B5C]/60 shadow-sm rounded-[2rem] p-8 shadow-2xl backdrop-blur-xl relative overflow-hidden"
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            <input
              ...
              className="w-full bg-white dark:bg-[#1A2235] border border-black/10 rounded-2xl px-5 py-4 text-base text-gray-900 dark:text-gray-100 placeholder:text-gray-600 dark:text-gray-400 focus:outline-none focus:ring-1 focus:ring-red-600 focus:border-red-600 transition-all shadow-inner"
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full bg-white dark:bg-[#1A2235] border border-black/10 rounded-2xl pl-5 pr-12 py-4 text-base text-gray-900 dark:text-gray-100 placeholder:text-gray-600 dark:text-gray-400 focus:outline-none focus:ring-1 focus:ring-red-600 focus:border-red-600 transition-all shadow-inner"
                placeholder="••••••••"
                required
              />
              <button
          ...
          <div className="flex items-center pt-2">
            <input
              ...
              className="w-5 h-5 rounded border-black/10 bg-white dark:bg-[#1A2235] text-red-600 focus:ring-red-600 focus:ring-offset-0"
            />
