...
export function MultimeterDetail({ component, onBack }: MultimeterDetailProps) {
  ...
  if (!component.multimeter) {
    return (
      <div className="min-h-screen bg-transparent text-gray-900 dark:text-gray-100 flex items-center justify-center p-6">
        <div className="text-center">
          <p className="text-gray-600 dark:text-gray-400 mb-4">Dados de multímetro indisponíveis para este componente.</p>
    ...
    <div className="min-h-screen bg-transparent text-gray-900 dark:text-gray-100 flex flex-col">
      <header className="px-6 pt-12 pb-5 border-b border-gray-200 dark:border-gray-700/80">
        <div className="max-w-3xl mx-auto w-full">
          <button
            onClick={onBack}
            className="flex items-center gap-2 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:text-gray-100 font-semibold mb-6 active:scale-95 transition-all text-sm w-fit bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:bg-gray-800 px-4 py-2 rounded-xl border border-gray-200 dark:border-gray-700/60 shadow-sm"
          >
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-gray-100">{component.name}</h1>
      ...
      <main className="flex-1 p-6 pb-12 overflow-y-auto max-w-3xl mx-auto w-full">
        ...
        >
          ...
          <div className="flex flex-col gap-6 py-8 px-4 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700/60 shadow-sm rounded-[2rem] overflow-hidden items-center backdrop-blur-sm shadow-xl relative">
          ...
          <section className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700/60 shadow-sm rounded-3xl p-6 md:p-8">
            ...
            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700/60 shadow-sm rounded-2xl p-5">
