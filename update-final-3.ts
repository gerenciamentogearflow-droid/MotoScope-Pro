...
6. Apenas texto puro (sem negritos, sem asteriscos). Mantenha longo para um áudio aprofundado (1-2 minutos falados).
      ...
      while (!success) {
          try {
            ...
            success = true;
             ...
             console.log("Rate limited! Sleeping 10s...", e.status);
